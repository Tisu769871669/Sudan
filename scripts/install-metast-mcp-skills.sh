...
echo "  python3 \$HOME/.openclaw/workspace/skills/metast-mcp/scripts/fetch_metast_mcp.py member-user-order-list --page-no 1 --page-size 20 --mobile MOBILE --status STATUS"
